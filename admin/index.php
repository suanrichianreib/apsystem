...
<body class="hold-transition login-page" style="background-image: url('/apsystem/images/bgc1.png'); background-size: cover;">
    <div class="login-box">
	<div class="login-logo" style="font-family: 'Bahnschrift Light SemiCondensed', sans-serif;">
    <b>Admin Login</b>
	</div>
