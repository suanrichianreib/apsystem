        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="position_add.php">
    				...
    				<div class="col-sm-9">
     			   <textarea class="form-control" id="rate" name="rate" rows="4"></textarea>
    				</div>
				</div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Update Position Details</b></h4>
          	</div>
          	<div class="modal-body">
				...
				<div class="form-group">
    				<label for="edit_rate" class="col-sm-3 control-label">Description</label>
    				<div class="col-sm-9">
     			   <textarea class="form-control" id="edit_rate" name="rate" rows="4"></textarea>
    				</div>
				</div>
                <!-- <div class="form-group">
