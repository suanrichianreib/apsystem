...
<body>
    ...
    <img class="img-fluid1" src="images/4foo.gif" alt="Logo" style="display: block; margin: 0 auto; width: 190px; height: auto;">
    <h1 style="font-weight: bold; font-size: 31px; margin-top: 40px; margin-bottom: 30px;">Have a bless day!</h1>
...
$(function() {
    var images = ['images/bill2.jpg', 'images/bill.jpg']; // List of background images
