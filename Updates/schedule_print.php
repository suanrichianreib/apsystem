<?php
	...
	function generateRow($conn){
		...
		$sql = "SELECT *, employees.id AS empid FROM employees LEFT JOIN schedules ON schedules.id=employees.schedule_id ORDER BY employees.lastname ASC, employees.firstname ASC";
    ...
    $content .= '
      	...
      	<table border="1" cellspacing="0" cellpadding="3">  
           <tr>  
                ...
                <th width="20%" align="center"><b>Auto Time Out</b></th> 
           </tr>  
      ';  
